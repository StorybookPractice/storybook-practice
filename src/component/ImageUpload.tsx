...
import useGetPreviewFile from '../hooks/useGetPreviewFile';
import { useIsFileSizeLessThanLimitation, IMAGE_FILE_SIZE_LIMITATION, useIsFileTypeImage } from '../hooks/useValidation';
import DefaultBoardThumbnail from './DefaultThumbnailButton';
